...
| 14  | The day our upload queue got stuck                                                 | Teams with background uploads: a real Pulse media-queue failure, how it was found and fixed                   | Abhishek's account (2026-09-25 interview): a stuck media upload queue at Pulse; `career.ts`: "background media upload queue"                                             | What broke, how it surfaced, the fix; add to the Pulse case study first   | idea   |
