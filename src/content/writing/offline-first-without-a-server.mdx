...
description: 'HelperBook has no signup and no backend. Why I built a household payroll app that never talks to a server, and what that trade-off costs.'
pubDate: 2026-09-24
...
{/* ASK ABHISHEK: what made you pick this problem — a specific household need you saw, or a general observation about how families track this today? */}
...
have. It's currently in closed beta on Google Play with 12–20 households, built with Jetpack Compose,
min SDK 24, target API 35.

{/* ASK ABHISHEK: any early signal from the closed-beta households worth mentioning once there's something concrete to say? */}
...
{/* ASK ABHISHEK: anything you'd point to about where the export/restore feature is headed, if you want to hint at what's next without over-promising? */}
